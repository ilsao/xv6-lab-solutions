...
int main()
{
  ...
  10:	3de080e7          	jalr	990(ra) # 3ea <pipe>

    int p2[2];
    pipe(p2);
  14:	fe040513          	addi	a0,s0,-32
  18:	00000097          	auipc	ra,0x0
  1c:	3d2080e7          	jalr	978(ra) # 3ea <pipe>
  ...
  24:	3b2080e7          	jalr	946(ra) # 3d2 <fork>
  28:	ed3d                	bnez	a0,a6 <main+0xa6>
        close(p2[1]);
  2a:	fe442503          	lw	a0,-28(s0)
  2e:	00000097          	auipc	ra,0x0
  32:	3d4080e7          	jalr	980(ra) # 402 <close>
        close(p1[0]);
  36:	fe842503          	lw	a0,-24(s0)
  3a:	00000097          	auipc	ra,0x0
  3e:	3c8080e7          	jalr	968(ra) # 402 <close>
        read(p2[0], &buf, 1);
  42:	4605                	li	a2,1
  44:	fdf40593          	addi	a1,s0,-33
  48:	fe042503          	lw	a0,-32(s0)
  4c:	00000097          	auipc	ra,0x0
  50:	3a6080e7          	jalr	934(ra) # 3f2 <read>
        printf("%d: received ping\n", getpid());
  54:	00000097          	auipc	ra,0x0
  58:	406080e7          	jalr	1030(ra) # 45a <getpid>
  5c:	85aa                	mv	a1,a0
  5e:	00001517          	auipc	a0,0x1
  62:	8c250513          	addi	a0,a0,-1854 # 920 <malloc+0xf0>
  66:	00000097          	auipc	ra,0x0
  6a:	70a080e7          	jalr	1802(ra) # 770 <printf>
        write(p1[1], "o", 1);
  6e:	4605                	li	a2,1
  70:	00001597          	auipc	a1,0x1
  74:	8c858593          	addi	a1,a1,-1848 # 938 <malloc+0x108>
  78:	fec42503          	lw	a0,-20(s0)
  7c:	00000097          	auipc	ra,0x0
  80:	37e080e7          	jalr	894(ra) # 3fa <write>
        close(p2[0]);
  84:	fe042503          	lw	a0,-32(s0)
  88:	00000097          	auipc	ra,0x0
  8c:	37a080e7          	jalr	890(ra) # 402 <close>
        close(p1[1]);
  ...
  a2:	33c080e7          	jalr	828(ra) # 3da <exit>
        close(p1[1]);
  a6:	fec42503          	lw	a0,-20(s0)
  aa:	00000097          	auipc	ra,0x0
  ae:	358080e7          	jalr	856(ra) # 402 <close>
        close(p2[0]);
  b2:	fe042503          	lw	a0,-32(s0)
  b6:	00000097          	auipc	ra,0x0
  ba:	34c080e7          	jalr	844(ra) # 402 <close>
        write(p2[1], "i", 1);
  be:	4605                	li	a2,1
  c0:	00001597          	auipc	a1,0x1
  c4:	88058593          	addi	a1,a1,-1920 # 940 <malloc+0x110>
  c8:	fe442503          	lw	a0,-28(s0)
  cc:	00000097          	auipc	ra,0x0
  d0:	32e080e7          	jalr	814(ra) # 3fa <write>
        read(p1[0], &buf, 1);
  d4:	4605                	li	a2,1
  d6:	fdf40593          	addi	a1,s0,-33
  da:	fe842503          	lw	a0,-24(s0)
  de:	00000097          	auipc	ra,0x0
  e2:	314080e7          	jalr	788(ra) # 3f2 <read>
        printf("%d: received pong\n", getpid());
  e6:	00000097          	auipc	ra,0x0
  ea:	374080e7          	jalr	884(ra) # 45a <getpid>
  ee:	85aa                	mv	a1,a0
  f0:	00001517          	auipc	a0,0x1
  f4:	85850513          	addi	a0,a0,-1960 # 948 <malloc+0x118>
  f8:	00000097          	auipc	ra,0x0
  fc:	678080e7          	jalr	1656(ra) # 770 <printf>
        close(p1[0]);
 100:	fe842503          	lw	a0,-24(s0)
 104:	00000097          	auipc	ra,0x0
 108:	2fe080e7          	jalr	766(ra) # 402 <close>
        close(p2[1]);
 10c:	fe442503          	lw	a0,-28(s0)
 110:	00000097          	auipc	ra,0x0
 114:	2f2080e7          	jalr	754(ra) # 402 <close>
 118:	b751                	j	9c <main+0x9c>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4e0:	48488893          	addi	a7,a7,1156 # 960 <digits>
 ...
 500:	0007c783          	lbu	a5,0(a5) # 4000000 <base+0x3ffeff0>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5b0:	3b4b8b93          	addi	s7,s7,948 # 960 <digits>
 ...
 6ec:	29048493          	addi	s1,s1,656 # 978 <digits+0x18>
        while(*s != 0){
