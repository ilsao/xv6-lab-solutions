...
print(const char *s)
{
  ...
  20:	3e2080e7          	jalr	994(ra) # 3fe <write>
}
  24:	60e2                	ld	ra,24(sp)
  26:	6442                	ld	s0,16(sp)
  28:	64a2                	ld	s1,8(sp)
...
forktest(void)
{
  ...
  3e:	46650513          	addi	a0,a0,1126 # 4a0 <pgaccess+0xa>
  ...
  54:	386080e7          	jalr	902(ra) # 3d6 <fork>
    if(pid < 0)
  ...
  68:	44c50513          	addi	a0,a0,1100 # 4b0 <pgaccess+0x1a>
  6c:	00000097          	auipc	ra,0x0
  70:	f94080e7          	jalr	-108(ra) # 0 <print>
    exit(1);
  74:	4505                	li	a0,1
  76:	00000097          	auipc	ra,0x0
  7a:	368080e7          	jalr	872(ra) # 3de <exit>
      exit(0);
  ...
  98:	352080e7          	jalr	850(ra) # 3e6 <wait>
  ...
  aa:	340080e7          	jalr	832(ra) # 3e6 <wait>
  ae:	57fd                	li	a5,-1
  ...
  b8:	44c50513          	addi	a0,a0,1100 # 500 <pgaccess+0x6a>
  ...
  d4:	40050513          	addi	a0,a0,1024 # 4d0 <pgaccess+0x3a>
  d8:	00000097          	auipc	ra,0x0
  dc:	f28080e7          	jalr	-216(ra) # 0 <print>
      exit(1);
  e0:	4505                	li	a0,1
  e2:	00000097          	auipc	ra,0x0
  e6:	2fc080e7          	jalr	764(ra) # 3de <exit>
    print("wait got too many\n");
  ea:	00000517          	auipc	a0,0x0
  ee:	3fe50513          	addi	a0,a0,1022 # 4e8 <pgaccess+0x52>
  f2:	00000097          	auipc	ra,0x0
  f6:	f0e080e7          	jalr	-242(ra) # 0 <print>
    exit(1);
  fa:	4505                	li	a0,1
  fc:	00000097          	auipc	ra,0x0
 100:	2e2080e7          	jalr	738(ra) # 3de <exit>
...
_main()
{
 ...
 134:	2ae080e7          	jalr	686(ra) # 3de <exit>
...
gets(char *buf, int max)
{
 ...
 238:	1c2080e7          	jalr	450(ra) # 3f6 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 28a:	198080e7          	jalr	408(ra) # 41e <open>
  if(fd < 0)
 ...
 29a:	1a0080e7          	jalr	416(ra) # 436 <fstat>
 29e:	892a                	mv	s2,a0
  close(fd);
 2a0:	8526                	mv	a0,s1
 2a2:	00000097          	auipc	ra,0x0
 2a6:	164080e7          	jalr	356(ra) # 406 <close>
  return r;
}
 2aa:	854a                	mv	a0,s2
